 ...
 * @returns 响应式数据和方法
 */
export function useJobRecommend() {
     ...
     */
    watch(() => resumeStore.analysisResult, (newResult) => {
     ...
     * 监听store中的岗位推荐结果变化
     */
    watch(() => resumeStore.jobMatchResult, (newResult) => {
     ...
     * 处理岗位推荐
     */
    const handleJobRecommend = async () => {
